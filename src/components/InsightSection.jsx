    ...
    <div className="h-fit py-12 flex justify-center items-center">
      <div className="h-fit w-[95%] flex flex-col lg:items-start items-center gap-12">
        ...
        <div className="text-white px-4 w-full">
          <div className="flex flex-col lg:flex-row justify-evenly gap-6 lg:gap-10">
            {/* Card 1 */}
            <div className="border border-neutral-800 duration-300 ease-in-out hover:border-[#0077B4] bg-neutral-800 rounded-[1.4375rem] w-full lg:w-[30%] px-4 py-8 flex flex-col gap-6 hover:scale-95 cursor-pointer">
              <img
