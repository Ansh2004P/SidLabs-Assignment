...
const CustomCard = ({ number, title, description, imgSrc, imgAlt }) => {
  return (
    <div className="z-30 border border-sky-700 rounded-lg shadow-lg lg:w-[32%] w-[75%] flex justify-center items-center lg:self-end cursor-pointer duration-300 ease-in hover:scale-105 sm:mx-auto">
